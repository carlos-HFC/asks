...
const remetent = nodemailer.createTransport({
   ...
   secure: true, //segurança - true para porta 465, false para as demais
...
const sendEmail = {
   ...
   bcc: 'exemplo@dominio.com', //com cópia
   cc: 'exemplo@dominio.com', //cópia oculta
...
remetent.sendMail(sendEmail, (err, info) => {
   if (err) {
      console.log(err) //exibe erro se der errado
   } else {
